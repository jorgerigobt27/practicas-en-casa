...
package JavaStandard.Clase6.domain;
...
public class Persona {
	...
	public void insertar(Connection c) throws Exception {
        ...
        public void modificar (Connection c) throws Exception {
          String sql =
		"UPDATE empleados SET nombre = '"+ this.getNombre() + "', apellido= '"+ this.getApellido() + 
                "', remuneracion = "+ this.getRemuneracion() + " WHERE id = " + this.getId();
        ...
        public static void eliminar (Long empleadoId, Connection c) throws Exception {
          String sql =
